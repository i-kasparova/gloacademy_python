# 1. Ввести верхнюю границу и присвоить ей max, min = 0
# 2. Ввести (загадать) число в этом диапазоне
# 3. Вычислить следующее число по формуле min + (max - min) // 2
# 4. Сравнить полученное число с загаданным и получить ответ, больше или меньше загаданного числа
# 5. Если загаданное число меньше, то результату формулы присваивается max, иначе -- min
